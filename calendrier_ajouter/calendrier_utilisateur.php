...
<?php
	...
	<table class="calendrier">
		<caption class='moisagenda'><?php echo '<a href="?m='.$mois_avant.'&amp;y='.$annee_avant.'"><i class="glyphicon glyphicon-chevron-left arrowleft"></i></a>  '.$m[$numero_mois].' '.$annee.'  <a href="?m='.$mois_apres.'&amp;y='.$annee_apres.'"><i class="glyphicon glyphicon-chevron-right arrowleft"></i></a>'; ?></caption>
