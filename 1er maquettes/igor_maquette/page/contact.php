...
<head>
	...
	<link rel="icon" type="image/png" href="logo50x42.png">
...
<div id="contenu">
	<section id="section_form">
		<div class="container">
				...
				<div class="row">
		<!-- class well : permet d'améliorer l'aspect du formulaire -->		
					<form method="POST" action="" class="col-md-6 well">	
						<div class="form-group">
							<label for="nom">Nom : </label><input id="nom" type="text" class="form-control" />
						</div>
						<div class="form-group">
							<label for="prenom">Prenom : </label><input id="prenom" type="text" class="form-control" />
						</div>
						<div class="form-group">
							<label for="age">Date de naissance : </label><input id="age" type="date" class="form-control" />
						</div>			
						<div class="form-group">
							<label for="email">Email : </label><input id="email" type="email" class="form-control" />
						</div>	
						<div class="form-group">
							<label for="message">Message : </label><textarea id="message" class="form-control"></textarea>
						</div>		
						<div class="form-group">
							<input id="newsletter" type="checkbox" /><label for="newsletter"> Recevoir la newsletter</label>
						</div>	
						<div class="form-group">
