              ...
              <div class="row">
                <div class="col-md-10 col-md-offset-1 col-sm-12">
                  ...
                  <ul class="list-inline banner-social-buttons">
                    <li><a href="#" class="btn blue"><i class="fa fa-twitter"> <span class="network-name">Twitter</span></i></a></li>
                    <li><a href="#" class="btn blue"><i class="fa fa-facebook"> <span class="network-name">Facebook</span></i></a></li>
                    <li><a href="#" class="btn blue"><i class="fa fa-youtube-play"> <span class="network-name">Youtube</span></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
