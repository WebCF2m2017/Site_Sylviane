...
if(isset($_POST['titre'])&&isset($_POST['texte'])&&isset($_POST['url'])&&!empty($_POST['titre'])&&!empty($_POST['texte'])&&!empty($_POST['url'])){
    ...
    $sql_auteur ="INSERT INTO article (titre,texte,url) VALUES ('$titre','$texte','$url');";
    // on insert l'article
  ...
  content_css: [
    ...
    <body>
        ...
        <form action="" name="onsenfout" method="POST">
            ...
            <input type="text" class="form-control" name="url" placeholder="Votre url d'image" required /><br/>
